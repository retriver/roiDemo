...
alertify.defaults = {
    ...
    glossary:{
        title:'<span class="fa fa-info-circle fa-2x" style="vertical-align:middle;color:#3b8eb5;"></span> Information',
        ok: 'OK',
        cancel: 'Cancel'            
    },
    theme:{
...
if(!alertify.errorAlert){
	alertify.dialog('errorAlert',function factory(){
		return{
	    	build:function(){
	        	var errorHeader = '<span class="fa fa-times-circle fa-2x" style="vertical-align:middle;color:#c43d3d;"></span> Application Error';
...
if(!alertify.successAlert){
	alertify.dialog('successAlert',function factory(){
		return{
	    	build:function(){
	        	var errorHeader = '<span class="fa fa-check-circle fa-2x" style="vertical-align:middle;color:#55a12c;"></span> Success';
	                this.setHeader(errorHeader);
	            }
	        };
	    },false,'alert');
...
if(!alertify.infoAlert){
	alertify.dialog('infoAlert',function factory(){
		return{
	    	build:function(){
	        	var errorHeader = '<span class="fa fa-info-circle fa-2x" style="vertical-align:middle;color:#3b8eb5;"></span> Information';
	                this.setHeader(errorHeader);
	            }
	        };
	    },false,'alert');
...
if(!alertify.confirmAlert){
	alertify.dialog('confirmAlert',function factory(){
		return{
	    	build:function(){
	        	var errorHeader = '<span class="fa fa-question-circle fa-2x" style="vertical-align:middle;color:#d99a36;"></span> Confirm';
	                this.setHeader(errorHeader);
	            }
	        };
	    },false,'confirm');
